            ...
            <table class="table table-striped">
                ...
                <tbody class="text-center">
                    ...
                    <tr>
                        ...
                        <!-- <td width="10px">
                            <a class="btn btn-success btn-sm" href="{{route('admin.cometidos.asignar', $cometido)}}">Asignar</a>
                        </td> -->
                        </td>
                        <td width="10px">
                        ...
                        <td width="10px">
                            <form action="{{route('admin.cometidos.liberar', $cometido)}}" method="POST">
                                @csrf
                                {{method_field('put')}}
                                <button type="submit" class="btn btn-primary btn-sm">LiberarVeivulo</button>
                            </form>
                        </td>
                        @else
